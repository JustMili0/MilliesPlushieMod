...
public class MCTRecipeProvider extends FabricRecipeProvider {
    public MCTRecipeProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> future) {
        super(output, future);
    }
