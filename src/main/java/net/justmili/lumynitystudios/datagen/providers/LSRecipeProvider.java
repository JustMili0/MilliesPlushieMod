...
public class LSRecipeProvider extends FabricRecipeProvider {
    public LSRecipeProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> future) {
        super(output, future);
    }
